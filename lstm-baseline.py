...
# plt.figure()
# data_pd = pd.DataFrame.from_records([data.x, data.y]).transpose()
...
# ---- determine predictor contributions - jsta ----
# https://pytorch.org/tutorials/beginner/saving_loading_models.html

# state = {'state_dict': model.state_dict(),
#          'optimizer': optimiser.state_dict()
#         }
# torch.save(state, "lstm-baseline_model.pytorch")

state = torch.load("lstm-baseline_model.pytorch")

model = LSTM(lstm_input_size, h1, batch_size=num_test, output_dim=output_dim,
...
# iterate through the [first dimension, ,] of X_test
# setting each column in turn to it's mean value
# compute loss of each operation
